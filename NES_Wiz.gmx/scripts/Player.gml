...
draw_text (5,5, health);                                            //Supposed to show HP somewhere on screen, but can't get it to show up.
if health < 1                                                     //SUPER basic HP tracking. Currently results in infinite loop upon "death"
{
